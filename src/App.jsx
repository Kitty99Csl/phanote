...
const localParse = (text) => {
  ...
  const CAT_RULES = [
    ...
    // Bakery, sweets, snacks — very common English inputs
    [/\bcake\b|cupcake|cup\s*cake|cake\s*roll|pastry|bakery|doughnut|donut|croissant/i,'food',  0.93],
    [/\bcookie\b|\bbrownie\b|waffle|pancake|muffin|biscuit|cracker/i,               'food',  0.93],
    [/\bbread\b|toast|\bsandwich\b|hotdog|hot\s*dog|\bwrap\b|\bbun\b/i,         'food',  0.92],
    // Fruits & vegetables — common grocery/food inputs
    [/\bapple\b|\bbanana\b|\borange\b|\bmango\b|\bgrape\b|\bwatermelon\b/i,    'food',  0.92],
    [/\bfruit\b|\bberr(?:y|ies)\b|strawberr|avocado|papaya|lemon|lime/i,            'food',  0.92],
    [/\btomato\b|\bonion\b|\bgarlic\b|\bcarrot\b|\bcabbage\b|\bpotato\b/i,    'food',  0.90],
    // Proteins & dairy
    [/\bsausage\b|\bsalami\b|\bham\b|\bbacon\b|\bsteak\b|\bmeatball/i,         'food',  0.93],
    [/\bmilk\b|\bcheese\b|\byogurt\b|\bbutter\b|\bcream\b|\btofu\b/i,         'food',  0.91],
    // Condiments & spreads
    [/\bjam\b|\bhoney\b|\bsauce\b|\bketchup\b|\bmayonnaise\b|\bchili\b/i,     'food',  0.90],
    [/\bsnack\b|\bchips\b|\bcandy\b|\bchocolate\b|\bice\s*cream\b|\bcorn\b/i,'food',  0.92],
    // Drinks that aren't alcohol — water, juice plain (no restaurant context)
    [/\bwater\b(?!\s*bill|\s*supply)|\bjuice\b|\bsoda\b|\bcola\b|\bpepsi\b/i, 'drinks',0.88],
    ...
    [/\bktv\b|karaoke|ຄາລາໂອເກ|คาราโอเกะ/i,                                'entertainment', 0.97],
    [/\bconcert\b|\bmovie\b|cinema|\bparty\b|festival|ງານເຕັ້ນ/i,          'entertainment', 0.93],
    [/nightclub|\bbar\b(?!code)|night\s*market|ງານບຸນ|ດິສໂກ້|disco/i,      'entertainment', 0.90],
